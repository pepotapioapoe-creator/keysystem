...
local Config = {
    ...
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/kxWAyuY3W",
    
    ShowInstagram   = false,
    InstagramURL    = "https://www.instagram.com/oyb0i/",
    
    ShowYoutube     = true,
    YoutubeURL      = "https://youtube.com/@zvolthud?si=q4kd2Qp2-bAGJBl7",
    ...
    HubDescription  = "Join the Discord channel" -- The text shown below the title
}
